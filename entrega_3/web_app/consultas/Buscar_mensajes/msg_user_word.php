...
<html>
	<head>
	    ...
	    <title>Mensajes enviados por un usuario que contenga una palabra especifica</title>
	</head>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<h3>Mensajes enviados por un usuario que contenga una palabra especifica</h3>
				</div>
				<div class="row">
