...
<html>
	<head>
	    ...
	    <title>Mensajes enviados por un usuario que no contenga una palabra especifica</title>
	</head>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<h3>Mensajes enviados por un usuario que no contenga una palabra especifica</h3>
				</div>
				<div class="row">
